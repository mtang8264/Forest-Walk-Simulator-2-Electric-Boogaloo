...
Shader "Toon/Specular"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( ( SAMPLE_TEXTURE2D( _Texture, sampler_Texture, uv_Texture ) * _AlbedoColor ) * ( smoothstepResult32 + _AmbientLightingColor + ( ( smoothstepResult55 * _SpecularColor ) * ase_lightAtten ) ) * ase_lightColor.a ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18400
584;404;1079;845;1490.438;171.4805;2.2;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-1030.636,936.9897;Inherit;False;Property;_Glossiness;Glossiness;4;0;Create;True;0;0;False;0;False;0;23.97;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;45;-212.763,1100.248;Inherit;False;Property;_SpecularColor;Specular Color;3;0;Create;True;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=541BA137E5B4CE89AB55243B1D3BA8E7D545EE2B